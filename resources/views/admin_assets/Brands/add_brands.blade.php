 ...
 <div class="page-content container container-plus">
   <div class="card acard mt-2 mt-lg-3">
    ...
    <div class="card-body px-3 pb-1">
      <form class="mt-lg-3" enctype="multipart/form-data" autocomplete="off" method="POST" action="{{route('store-brand')}}">
        @csrf
        <div class="form-group row">
          <div class="col-sm-6">
               Name *
               <input type="text" name="name" value="{{old('name')}}" class="form-control brc-on-focus brc-success-m1" id="product_name" />
               @if ($errors->has('name'))
          ...
          <div class="col-sm-6">
            {{-- Image *
            <input type="file" name="image" value="{{old('image')}}" class="ace-file-input" id="ace-file-input1" />
            @if ($errors->has('image'))
         ...
         <div class="form-group row">
            <div class="col-sm-6">
              Description 
              <textarea type="text"  value="" class="form-control brc-on-focus brc-success-m1" id="description" name="description"></textarea>
