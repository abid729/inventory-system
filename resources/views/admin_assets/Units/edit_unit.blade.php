 ...
 <div class="page-content container container-plus">
   <div class="card acard mt-2 mt-lg-3">
    ...
    <div class="card-body px-3 pb-1">
      <form class="mt-lg-3" enctype="multipart/form-data" autocomplete="off" method="POST" action="{{ route('update-unit', $unit->id) }}">
        @csrf
        <div class="form-group row">
          <div class="col-sm-6">
               Name *
               <input type="text" name="name" value="{{$unit->name}}" class="form-control brc-on-focus brc-success-m1" id="product_name" />
               @if ($errors->has('name'))
          ...
          <div class="col-sm-6">
            Short Name *
            <input type="text" name="short_name" value="{{$unit->name}}" class="form-control brc-on-focus brc-success-m1" id="short_name" />
       ...
       <div class="form-group row">
        <div class="col-sm-6">
             ...
             <select id="form-field-chosen-1" data-placeholder="Choose a state..." name = "base_unit" class="chosen-select form-control">
              <option value=""></option>
              @if ('Bore' == $unit->base_unit)
              <option value="Bore" selected>Bore</option>
             @elseif('Liter' == $unit->base_unit)
