    ...
    <div class="page-header mb-2 pb-2 flex-column flex-sm-row align-items-start align-items-sm-center py-25 px-1">
      <h1 class="page-title text-primary-d2 text-140">
        ...
        <small class="page-info text-dark-m3">
         <a href="{{ route('create-unit') }}"> <i class="fa fa-plus" data-toggle="tooltip" data-placement="top" data-original-title="Add New Unit"></i></a>
        </small>
      </h1>
            ...
            <tr class="d-style bgc-h-default-l4">
              ...
              <td class="align-middle">
                <span class="d-none d-lg-inline">
                    <a data-rel="tooltip"  title="Edit" href="{{ route('edit-unit', $row->id ) }}" class="v-hover">
                        <i class="fa fa-edit text-blue-m1 text-120"></i>
                    </a>
                    <a title="Delete" href=" {{ route('delete-unit', $row->id ) }}" class="btn btn-outline-info shadow-sm px-4 btn-bgc-white">
                ...
                <span class="d-lg-none text-nowrap">
                    <a title="Edit" href="{{ route('edit-unit', $row->id ) }}" class="btn btn-outline-info shadow-sm px-4 btn-bgc-white">
