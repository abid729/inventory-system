 ...
 <div class="page-content container container-plus">
   <div class="card acard mt-2 mt-lg-3">
    ...
    <div class="card-body px-3 pb-1">
      <form class="mt-lg-3" enctype="multipart/form-data" autocomplete="off" method="POST" action="{{ route('update-category', $category->id) }}">
        @csrf
        <div class="form-group row">
          <div class="col-sm-6">
               Name *
               <input type="text" name="name" value="{{$category->name}}" class="form-control brc-on-focus brc-success-m1" id="product_name" />
               @if ($errors->has('name'))
         ...
         <div class="form-group row">
           <div class="col-sm-6">
            @if ("/storage/images/{{ $category->image }}")
            <img src="{{ asset('images/'.$category->image) }}" style="width: 50%">
            @else
                <p>No image found</p>
            @endif
           </div>
